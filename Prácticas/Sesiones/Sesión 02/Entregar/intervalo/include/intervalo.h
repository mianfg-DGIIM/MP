...
public:
	...
	/**
	 * @brief Realiza la intersección de dos intervalos, puede
	 ...
	 * intersección entre los dos intervalos de entrada
	 */
	friend Intervalo interseccion(const Intervalo & i1, const Intervalo & i2);
};
