...
/**
 * @brief Ordena un vector de bigramas de forma descendente por frecuencias
 * @param v El vector de bigramas
 * @param n Tamaño de @a v
 */
...
/**
 * @brief Determina si el primer bigrama es menor alfabéticamente que el segundo
 * @param a El primer bigrama
 * @param b El segundo bigrama
 * @return si el bigrama a es mayor que b
 */
bool esBigramaMenor( const char* a, const char* b );

/**
 * @brief Transforma un caracter a su minúscula
 * @param caracter El caracter a transformar @cond Debe ser una letra
 * @return El caracter en minúscula
 */
